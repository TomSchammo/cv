...
\multicolumn{2}{@{}X@{}}{
    \footnotesize{
    As part of a self-driving car research project, I took full ownership of the development of a \href{https://github.com/ekut-es/LidarAug}{Lidar point cloud augmentation library}.
